...
import '../CSS/TopTenTable.css'; // 导入 CSS 文件
            ...
            {currentItems.map((item, index) => (
              <TableRow key={item.id} className="ranking-item">
                ...
                <TableCell align="center">
                  <img src={item.cover} alt={item.title} className="ranking-avatar" />
                </TableCell>
                <TableCell align="center">{item.title}</TableCell>
                <TableCell align="center">{item.level}</TableCell>
                <TableCell align="center">{item.province}</TableCell>
                <TableCell align="center" className="ranking-score">{item.score}</TableCell>
